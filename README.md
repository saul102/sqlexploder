...
A powerful, browser-based SQL analysis and visualization tool that parses SQL files and creates interactive dependency graphs showing relationships between files, tables, stored procedures, and string literals.
